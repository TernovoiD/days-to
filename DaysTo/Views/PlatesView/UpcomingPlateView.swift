...
//                            ForEach(daysToVM.sortedEvents.indices, id: \.self) { index in
//                                    if index < 3 {
//                                        let indexName = "\(index + 1).square"
//                                        let eventName = daysToVM.sortedEvents[index].name ?? "No name"
//                                        HStack {
...
//}
//
//struct UpcomingPlateView_Previews: PreviewProvider {
